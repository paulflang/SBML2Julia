...
@NLconstraint(m, [k in 1:length(t_sim)-1],
    Cb[k+1] == Cb[k] + ( -1.0*(kWee2 * Cb[k+1] * Wee[k+1]) -1.0*(kWee1 * Cb[k+1]) +1.0*(kCdc25_1 * pCb[k+1]) +1.0*(kCdc25_2 * pCb[k+1] * pCdc25[k+1]) -1.0*(kPhCdc25 * Cb[k+1] * Cdc25[k+1]) +1.0*(kPhCdc25 * Cb[k+1] * Cdc25[k+1]) -1.0*(kPhWee * Cb[k+1] * Wee[k+1]) +1.0*(kPhWee * Cb[k+1] * Wee[k+1]) -1.0*(kPhGw * Gw[k+1] * Cb[k+1]) +1.0*(kPhGw * Gw[k+1] * Cb[k+1]) ) * ( t_sim[k+1] - t_sim[k] ) )
@NLconstraint(m, [k in 1:length(t_sim)-1],
...
@NLconstraint(m, [k in 1:length(t_sim)-1],
    Wee[k+1] == Wee[k] + ( -1.0*(kWee2 * Cb[k+1] * Wee[k+1]) +1.0*(kWee2 * Cb[k+1] * Wee[k+1]) -1.0*(kPhWee * Cb[k+1] * Wee[k+1]) +1.0*(kDpWee * pWee[k+1] * B55[k+1]) ) * ( t_sim[k+1] - t_sim[k] ) )
@NLconstraint(m, [k in 1:length(t_sim)-1],
...
@NLconstraint(m, [k in 1:length(t_sim)-1],
    pCdc25[k+1] == pCdc25[k] + ( -1.0*(kCdc25_2 * pCb[k+1] * pCdc25[k+1]) +1.0*(kCdc25_2 * pCb[k+1] * pCdc25[k+1]) +1.0*(kPhCdc25 * Cb[k+1] * Cdc25[k+1]) -1.0*(kDpCdc25 * pCdc25[k+1] * B55[k+1]) ) * ( t_sim[k+1] - t_sim[k] ) )
@NLconstraint(m, [k in 1:length(t_sim)-1],
    Gw[k+1] == Gw[k] + ( -1.0*(kPhGw * Gw[k+1] * Cb[k+1]) +1.0*(kDpGw1 * pGw[k+1]) +1.0*(kDpGw2 * pGw[k+1] * B55[k+1]) ) * ( t_sim[k+1] - t_sim[k] ) )
@NLconstraint(m, [k in 1:length(t_sim)-1],
    pGw[k+1] == pGw[k] + ( +1.0*(kPhGw * Gw[k+1] * Cb[k+1]) -1.0*(kDpGw1 * pGw[k+1]) -1.0*(kDpGw2 * pGw[k+1] * B55[k+1]) -1.0*(kPhEnsa * Ensa[k+1] * pGw[k+1]) +1.0*(kPhEnsa * Ensa[k+1] * pGw[k+1]) ) * ( t_sim[k+1] - t_sim[k] ) )
@NLconstraint(m, [k in 1:length(t_sim)-1],
...
@NLconstraint(m, [k in 1:length(t_sim)-1],
    B55[k+1] == B55[k] + ( -1.0*(kDpCdc25 * pCdc25[k+1] * B55[k+1]) +1.0*(kDpCdc25 * pCdc25[k+1] * B55[k+1]) -1.0*(kDpWee * pWee[k+1] * B55[k+1]) +1.0*(kDpWee * pWee[k+1] * B55[k+1]) -1.0*(kDpGw2 * pGw[k+1] * B55[k+1]) +1.0*(kDpGw2 * pGw[k+1] * B55[k+1]) -1.0*(kAspEB55 * B55[k+1] * pEnsa[k+1]) +1.0*(kDipEB55 * pEB55[k+1]) +1.0*(kDpEnsa * pEB55[k+1]) ) * ( t_sim[k+1] - t_sim[k] ) )
