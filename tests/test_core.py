...
class DisFitProblemTestCase(unittest.TestCase):
    ...
    def test_constructor(self):
        ...
        with open('tmp_code_petab.jl', 'w') as f:
            f.write(problem.julia_code)
    ...
    def test_optimize_results_plot(self):
        ...
        #     for state in results_gold['observables'][i_iter].keys():
        #         assert_allclose(results['observables'][i_iter][state], results_gold['observables'][i_iter][state])
        ...
        # test_plot_results()
        problem.plot_results(path='plot.pdf')
        problem.plot_results(path=os.path.join(self.dirname, 'plot.pdf'))
        problem.plot_results(path=os.path.join(self.dirname, 'plot.pdf'), observables=['obs_Ensa', 'obs_pEnsa'])
