...
project = u'calc'
copyright = u'{}, Paul Lang'.format(datetime.datetime.now().year)
author = u'Paul Lang'
...
filename = os.path.join(os.path.dirname(__file__), '..', 'calc', 'VERSION')
...
def linkcode_resolve(domain, info):
    ...
    if os.path.isfile(os.path.join(os.path.dirname(__file__), '..', rel_filename + '.py')):
        return "https://github.com/paulflang/calc/blob/master/{}.py".format(rel_filename)
    else:
        return "https://github.com/paulflang/calc/blob/master/{}/__init__.py".format(rel_filename)
